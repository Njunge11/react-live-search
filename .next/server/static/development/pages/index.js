...
class Index extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  async queryForMovies(queryText) {
    ...
    const results = await Object(_src_utils__WEBPACK_IMPORTED_MODULE_1__["default"])(url);
...
const search = async query => {
  ...
  try {
    ...
    const res = await axios__WEBPACK_IMPORTED_MODULE_0___default()(query, {
    ...
    if (axios__WEBPACK_IMPORTED_MODULE_0___default.a.isCancel) {
...
module.exports = __webpack_require__(/*! /home/njunge/Projects/front-end/react-live-search/pages/index.js */"./pages/index.js");
